  ...
  <div class="container">
    ...
    <div class="row clearfix work-row-inner">
      ...
      <div class="col-sm-4 grid-item">
        ...
        <?php if (get_sub_field('work_row_13_23_left') ) : ?>

          <?php if( have_rows('work_row_13_23_left') ): ?>
              <?php while( have_rows('work_row_13_23_left') ): the_row();  ?>

                <?php if (get_sub_field('work_row_13_23_left_external_link_toggle') ) : ?>
     ...
     <div class="col-sm-7 col-sm-offset-1 grid-item">
       ...
       <?php if (get_sub_field('work_row_13_23_right') ) : ?>

         <?php if( have_rows('work_row_13_23_right') ): ?>
             <?php while( have_rows('work_row_13_23_right') ): the_row();  ?>

               <?php if (get_sub_field('work_row_13_23_right_external_link_toggle') ) : ?>
